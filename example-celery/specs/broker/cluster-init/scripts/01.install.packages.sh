...
jetpack download --project celery-autoscale-demo cyclecloud-scalelib-1.0.2.tar.gz $CYCLECLOUD_SPEC_PATH/files/
pip install $CYCLECLOUD_SPEC_PATH/files/cyclecloud-scalelib-1.0.2.tar.gz
