...
jetpack download --project celery-autoscale-demo cyclecloud-scalelib-0.2.12.tar.gz $CYCLECLOUD_SPEC_PATH/files/
pip install $CYCLECLOUD_SPEC_PATH/files/cyclecloud-scalelib-0.2.12.tar.gz
